...
$quaryInsert=mysqli_query($sqlInsert);
	...
	<!-- ------- start  form -------- -->
             ...
             <form action="addItem.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="fdescription" type="text" required="required" class="form-control" id="Descriptionitem" placeholder="made from kenya">
                  </div>

                  <!-- price  -->
                <div class="form-group">
                    <label for="priceitem">price</label>
                    <input name="fprice" type="text" required="required" class="form-control" id="priceitem"  placeholder=" 10,000 ksh.">
                  </div>
              </div>
